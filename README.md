...
The basic setup of this system is:
- A monitor device made up of sensors connected to a Raspberry Pi device running client code
- A web server to receive and display measurements
- A cloud sharing program
